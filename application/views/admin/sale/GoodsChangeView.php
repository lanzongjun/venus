...
<body>
<table id="dg" title="销售管理-调度" class="easyui-datagrid" toolbar="#dom_toolbar1" data-options="border:false,fit:true,rownumbers:true,singleSelect:true,method:'get',url:'../<?php echo $c_name; ?>/getList/',pagination:true,pageSize:50,pageList: [50, 100, 200, 300]">
    <thead>
    <tr>
...
<!--                <td>-->
<!--                    <div style="margin-left:5px;margin-bottom:5px">-->
<!--                        <input class="easyui-combobox" name="change_shop" readonly disabled data-options="-->
