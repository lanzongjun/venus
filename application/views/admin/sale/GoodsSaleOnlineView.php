...
<div id="tab_box" class="easyui-tabs" data-options="fit:true">
    <div title="商品线上销售">
        <table id="dg" class="easyui-datagrid" data-options="fit:true,rownumbers:true,singleSelect:true,method:'get',url:'../GoodsSaleOnline/getList/',toolbar:toolbar1,pagination:true,pageSize:50,pageList: [50, 100, 200, 300]">
            <thead>
            <tr>
...
<div id="cp_win_input" class="easyui-window" title="导入数据" data-options="modal:true,closed:true,iconCls:'icon-add'" style="width:300px;height:200px;padding:10px;">
    <form id="form_input" method="post" enctype="multipart/form-data">
        ...
        <br/><br/>
        <input name="upload_file" class="easyui-filebox" data-options="prompt:'选择一个CSV文件...'" style="width:100%">
        <br/><br/>
...
<script src="<?php echo base_url("/resource/admin/sale/GoodsSaleOnline.js") ?>" type="text/javascript"></script>
</body>
</html>
