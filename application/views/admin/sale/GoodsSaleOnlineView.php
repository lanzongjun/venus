...
<table id="dg"  title="销售-线上销售" class="easyui-datagrid" data-options="fit:true,rownumbers:true,singleSelect:true,method:'get',url:'../sale/GoodsSaleOnlineController/getList/',toolbar:toolbar1,pagination:true,pageSize:50,pageList: [50, 100, 200, 300]">
    <thead>
    <tr>
