...
var __i_eboitd_refresh_rate = 60000;
var __b_eboitd_auto_refresh = false;
...
function refreshData(){
    $('#dg').datagrid('load');
    __o_eboitd_refresh_handler = setTimeout(refreshData,__i_eboitd_refresh_rate);
}
